...
def main() -> None:
    ...
    report["checks"]["ablation_summary_exists"] = (WEBSITE / "assets" / "tables" / "ablation_summary.csv").exists()
    report["checks"]["mambacd_protocol_ours_exists"] = (WEBSITE / "assets" / "data" / "mambacd_protocol_ours.json").exists()
    report["checks"]["mambacd_paper_comparison_exists"] = (WEBSITE / "assets" / "data" / "mambacd_paper_comparison.json").exists()
    ...
    report["checks"]["ablation_section_present"] = "id=\"ablation\"" in html
    report["checks"]["mambacd_protocol_section_present"] = "id=\"mambacd-protocol\"" in html
    report["checks"]["mambacd_mapping_table_present"] = "id=\"mambacd-mapping-table\"" in html
